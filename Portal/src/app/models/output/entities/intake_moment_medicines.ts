...
@Index("fk_Intake_moment_has_Medicine_Medicine1_idx",["medicine_",])
@Index("fk_Intake_moment_has_Medicine_Intake_moment1_idx",["intake_moment_",])
export class intake_moment_medicines {
    ...
    intake_moment_:intake_moment | null;
